...
// Fetch all candidates for Vice President (position_id = 2)
$sql = "SELECT candidate_id, candidate_fname, candidate_lname, party_list, candidate_img FROM candidate WHERE position_id = 2";
