...
// Fetch all candidates for President (position_id = 1)
$sql = "SELECT candidate_id, candidate_fname, candidate_lname, party_list, candidate_img FROM candidate WHERE position_id = 1";
